...
const WHATSAPP_VISIT_FR =
  'https://wa.me/5521992973454?text=Bonjour%2C%20je%20souhaiterais%20plus%20d%27informations%20sur%20l%27Escola%20Montessoriana%20de%20Laranjeiras.';
...
const FloatingWhatsAppFr: React.FC = () => (
  <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-10 sm:gap-12 min-w-0">
          <div className="space-y-4 min-w-0">
            ...
            <p className="text-amber-200/95 text-base sm:text-lg font-normal max-w-xs leading-relaxed">
              Aider chaque enfant à devenir l'adulte qu'il porte en lui.
            </p>
            <div className="pt-4">
              <MapaEscola titulo="Localisation de l'Escola Montessoriana de Laranjeiras" rotulo="Voir la carte" abrir="Ouvrir dans Google Maps" />
            </div>
            <a
          ...
          <div className="space-y-4 min-w-0">
            <h4 className="font-bold uppercase tracking-widest text-montessori-gold text-base">Contact</h4>
            <a
            ...
            >
              ...
              <span>Rua das Laranjeiras, 540, fundos<br />Laranjeiras, Rio de Janeiro - RJ, Brésil</span>
            </a>
            ...
            >
              ...
              <span>
                <span className="block text-xs uppercase tracking-wider text-gray-400">Secrétariat</span>
                +55 (21) 96455-1080
              </span>
            </a>
          ...
          <div className="space-y-4 min-w-0">
            <h4 className="font-bold uppercase tracking-widest text-montessori-gold text-base">Suivez-nous</h4>
            <a
            ...
            <p className="text-sm text-gray-500 mt-8">
              © {new Date().getFullYear()} Escola Montessoriana de Laranjeiras. Tous droits réservés.
            </p>
          </div>
        </div>
      </footer>
