...
const periods = [
  {
    icon: <Sun size={28} />,
    name: 'Media jornada',
    times: ['Mañana · 8:00 a 12:00', 'Tarde · 13:00 a 17:00'],
    note: 'Tu hijo asiste por la mañana o por la tarde.',
  },
  {
    icon: <CalendarClock size={28} />,
    name: 'Jornada completa',
    times: ['8:00 a 17:00'],
    note: 'Un día entero en la escuela, con almuerzo y siesta.',
  },
  {
    icon: <Sunset size={28} />,
    name: 'Horario extendido',
    times: ['7:30 a 19:00'],
    note: 'Entrada más temprana y salida más tarde, para las familias que necesitan más tiempo.',
  },
];

export const HorariosEs: React.FC = () => (
  <Section id="schedule" className="bg-montessori-cream">
    ...
    <p className="text-center text-montessori-dark mt-8 sm:mt-10 font-medium px-1">
      <span className="text-montessori-green font-bold">Horarios flexibles:</span> adaptamos la hora de entrada y de salida
      a las necesidades de tu familia.
    </p>
  </Section>
);
