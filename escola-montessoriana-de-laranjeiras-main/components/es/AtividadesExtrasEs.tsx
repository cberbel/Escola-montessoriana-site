...
export const AtividadesExtrasEs: React.FC = () => (
  <Section id="activities" className="bg-white">
    <div className="text-center mb-10 sm:mb-14 min-w-0">
      ...
      <h2 className="font-serif font-bold text-3xl sm:text-4xl md:text-5xl text-montessori-green px-1 break-words leading-tight">
        Más allá del salón Montessori
      </h2>
      <p className="font-sans text-lg text-montessori-dark mt-4 max-w-2xl mx-auto px-1 leading-relaxed">
        Dos veces al día, por la mañana y por la tarde, a lo largo de la semana, los niños disfrutan de actividades
        que enriquecen el cuerpo, las artes y su conexión con la naturaleza.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 max-w-5xl mx-auto min-w-0">
      {activities.map((a) => (
        ...
        >
          <Foto
            src={a.image}
            alt={`Actividad de ${a.name} en la Escola Montessoriana`}
            loading="lazy"
    ...
    <div className="max-w-3xl mx-auto mt-10 sm:mt-12 text-center min-w-0">
      <p className="text-montessori-green font-semibold mb-4">Todas las actividades complementarias:</p>
