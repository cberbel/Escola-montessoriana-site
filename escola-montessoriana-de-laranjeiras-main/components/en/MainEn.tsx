...
const WHATSAPP_VISIT_EN =
  'https://wa.me/5521992973454?text=Hello!%20I%20would%20like%20to%20schedule%20a%20visit%20to%20Escola%20Montessoriana.';
...
const FloatingWhatsAppEn: React.FC = () => (
  <a
  ...
  >
    <span className="hidden sm:inline font-semibold text-sm whitespace-nowrap">Book your visit</span>
      ...
      <footer className="bg-montessori-green text-white py-12 sm:py-16 border-t border-white/10 overflow-x-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-10 sm:gap-12 min-w-0">
          <div className="space-y-4 min-w-0">
            ...
            <div className="pt-4">
              <iframe
                title="Location of Escola Montessoriana de Laranjeiras"
          ...
          <div className="space-y-4 min-w-0">
            <h4 className="font-bold uppercase tracking-widest text-montessori-gold text-base">Follow us</h4>
            <a
            ...
            <p className="text-sm text-gray-500 mt-8">
              © {new Date().getFullYear()} Escola Montessoriana de Laranjeiras. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
